...
// String Validation
// export const validate_string = function(field_value: string, field_name: string, fixed_length: number, min_length: number, max_length: number, range_array: any[] | null) {
//     const error = {
//         message: "",
//         code: 0
//     };
...
//     if(fixed_length != 0) {
//         if(field_value.length != fixed_length) {
//             error.message = "Invalid Data: " + field_name + " can only contain " + fixed_length.toString() + " characters";
//             error.code = 400;
//             return error;
//         }
//     }
...
//             error.message = "Invalid Data: " + field_name + " should contain a minimum of " + min_length.toString() + " characters";
//             error.code = 400;
//             return error;
//         }
//     }
...
//             error.message = "Invalid Data: " + field_name + " can only contain up to " + max_length.toString() + " characters";
//             error.code = 400;
//             return error;
//         }
//     }
    
//     if(typeof(range_array) != 'undefined' && range_array != null) {
//         if(range_array.length > 0) {
//             let value_found = false;
            
//             for(let i=0; i < range_array.length; i++) {
//                 if(field_value == range_array[i]) {
//                     value_found = true;
//                 }
//             }
            
//             if(value_found == false) {
//                 error.message = "Invalid Data: " + field_name + " can only contain " + range_array.join(" or ") +  " and not " + field_value.toString();
//                 error.code = 400;
//                 return error;
//             }
//         }
...
export const validate_number = function (
    ...
    if (typeof field_value !== "number" || isNaN(field_value)) {
    ...
    // Uncomment and use this section to check if the input is a valid number in string
    // const regExp = /^[0-9]*$/;
    // if (regExp.test(field_value.toString()) === false) {
    //   error.message = `Invalid Data: ${field_name} can only contain numbers`;
    //   error.code = 400;
    //   return error;
    // }

    if (fixed_length !== 0 && str.length !== fixed_length) {
      error.message = `Invalid Data: ${field_name} can only contain ${fixed_length} characters`;
      error.code = 400;
      return error;
    }
  
    // Use parseFloat if you want to support decimal values
